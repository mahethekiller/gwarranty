    ...
    <div class="form-group row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select class="form-select" id="product_type" name="product_type" onchange="toggleProductDiv()">
                    <option value="" {{ $warranty->product_type == null ? 'selected' : '' }}>Select Product Type
                    </option>
                    <option value="Mikasa Floors" {{ $warranty->product_type == 'Mikasa Floors' ? 'selected' : '' }}>
                        Mikasa Floors</option>
                    <option value="Mikasa Doors" {{ $warranty->product_type == 'Mikasa Doors' ? 'selected' : '' }}>
                        Mikasa Doors</option>
                    <option value="Mikasa Ply" {{ $warranty->product_type == 'Mikasa Ply' ? 'selected' : '' }}>Mikasa
                        Ply</option>
                    <option value="Greenlam Clads" {{ $warranty->product_type == 'Greenlam Clads' ? 'selected' : '' }}>
                        Greenlam Clads</option>
                    <option value="NewMikaFx" {{ $warranty->product_type == 'NewMikaFx' ? 'selected' : '' }}>NewMikaFx
                    </option>
                    <option value="Greenlam Sturdo"
                        {{ $warranty->product_type == 'Greenlam Sturdo' ? 'selected' : '' }}>Greenlam Sturdo</option>
                </select>
