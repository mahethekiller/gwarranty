                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="phone_number" value="{{ Auth::user()->phone_number }}"
                                    type="text" placeholder="+91-88990 02244" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="city" name="city">
                                    <option value="">Select City {{ Auth::user()->city }}</option>
                                    @if (Auth::user()->state)
                                        @foreach ($cities as $city)
                                            <option value="{{ $city }}"
                                                {{ Auth::user()->city == $city ? 'selected' : '' }}>
                                                {{ $city }}
                                            </option>
                                        @endforeach
                                    @endif
                        ...
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label for="address" class="form-label custom-form-label">Full Address</label>
                                <input class="form-control" id="address" name="address"
                                    value="{{ Auth::user()->address }}" type="text" placeholder="Enter Address">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="pincode" value="{{ Auth::user()->pincode }}"
